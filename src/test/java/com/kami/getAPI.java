...
public APIBuilder apiBuilder = null;
	...
	@Test
	public void getproConfig() {
		Response response = apiBuilder.getproConfig("5548377","1","4777393");
	  ...
	  public void getproUserDetail() {
		 Response response = apiBuilder.getProUserDetails("4777393","1","4777393","pZe7R96O4b4VRnSyl/EpXD8hLUU=");
		  response.getBody().prettyPrint();
		  Assert.assertEquals(200,response.getStatusCode());
	  }
